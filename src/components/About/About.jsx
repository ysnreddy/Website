...
const About = () => {
  return (
    <div className="about container mx-auto p-8 bg-gray-100">
      <div className="about-container flex flex-col lg:flex-row items-center lg:items-start space-y-8 lg:space-y-0 lg:space-x-8">
        <div className="lg:w-1/2 w-full">
          <h3 className="font-bold text-3xl mb-4" id="About" >| About Us</h3>
          <p className="about-text text-gray-700 text-lg md:text-xl font-serif leading-relaxed">
        ...
        <div className="about-image lg:w-1/2 w-full rounded-lg shadow-lg transform transition duration-500 hover:scale-105 hover:shadow-2xl">
          <img
